(function () {
  ...
  */
  ...
  var newTodo = function newTodo(description, id) {
    return { description: description, completed: false, id: id };
  };

  var emptyApp = { todos: [], focus: null, filter: '/', nextId: 0 };

  var completedCount = function completedCount(_ref) {
    var todos = _ref.todos;
    return todos.reduce(countIfCompleted, 0);
  };

  var countIfCompleted = function countIfCompleted(count, _ref2) {
    var completed = _ref2.completed;
    return count + (completed ? 1 : 0);
  };

  var addTodo = function addTodo(description) {
    return function (app) {
      return _extends({}, app, {
        nextId: app.nextId + 1,
  ...
  var updateCompleted = function updateCompleted(completed, id) {
    return function (app) {
      return _extends({}, app, {
        todos: app.todos.map(function (todo) {
          return todo.id === id ? _extends({}, todo, { completed: completed }) : todo;
        })
      });
    };
  };

  var updateAllCompleted = function updateAllCompleted(completed) {
    return function (app) {
      return _extends({}, app, {
        todos: app.todos.map(function (todo) {
  ...
  var removeAllCompleted = function removeAllCompleted(app) {
    return _extends({}, app, {
      todos: app.todos.filter(function (todo) {
  ...
  */
  ...
  G.prototype = F.prototype;function H(a, b, e) {
    this.props = a;this.context = b;this.refs = emptyObject_1;this.updater = e || E;
  }var I = H.prototype = new G();I.constructor = H;objectAssign(I, F.prototype);I.isPureReactComponent = !0;
  ...
  var runAction = function runAction(app, action) {
    return action(app);
  };
  ...
  var handleRemoveAllCompleted = function handleRemoveAllCompleted(e) {
  ...
  var maybeClass = function maybeClass(className) {
  ...
  var filterTodos = function filterTodos(_ref) {
  ...
  var View = function View(addAction) {
    ...
    return react_1(
      ...
      react_1(
        ...
        react_1(
          ...
          react_1(
            'a',
            { className: ifSelected(filter === '/'), href: '#/' },
            'All'
          )
        ),
        react_1(
          ...
          react_1(
            'a',
            { className: ifSelected(filter === '/active'), href: '#/active' },
            'Active'
          )
        ),
        react_1(
          ...
          react_1(
            'a',
            { className: ifSelected(filter === '/completed'), href: '#/completed' },
            'Completed'
          )
        )
      ),
      completed > 0 && react_1(
        'button',
        { className: 'clear-completed', onClick: compose(addAction, handleRemoveAllCompleted) },
        'Clear completed'
      )
    );
  };

  var createEventAdapter = function createEventAdapter(scheduler) {
    var stream = new MulticastSource(never());
    return [function (action) {
      return stream.event(scheduler.currentTime(), action);
    }, stream];
  };
  ...
  "accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function (a) {
    var b = a.replace(Ec, Fc);J$1[b] = new I$1(b, 1, !1, a, null);
  });"xlink:actuate xlink:arcrole xlink:href xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function (a) {
    var b = a.replace(Ec, Fc);J$1[b] = new I$1(b, 1, !1, a, "http://www.w3.org/1999/xlink");
  });["xml:base", "xml:lang", "xml:space"].forEach(function (a) {
    var b = a.replace(Ec, Fc);J$1[b] = new I$1(b, 1, !1, a, "http://www.w3.org/XML/1998/namespace");
  ...
  function Jc(a) {
    ...
    a = H$1.getPooled(Oc.change, a, b, c);a.type = "change";Ob(c);Ya(a);return a;
  }var Qc = null,
  ...
  }var Vc = !1;ExecutionEnvironment_1.canUseDOM && (Vc = $b("input") && (!document.documentMode || 9 < document.documentMode));function Wc() {
  ...
  var bd = { eventTypes: Oc, _isInputEventSupported: Vc, extractEvents: function extractEvents(a, b, c, d) {
      ...
      cd = H$1.extend({ view: null, detail: null }),
      dd = { Alt: "altKey",
  ...
  var gd = cd.extend({ screenX: null, screenY: null, clientX: null, clientY: null, pageX: null, pageY: null, ctrlKey: null, shiftKey: null, altKey: null, metaKey: null, getModifierState: fd, button: null, buttons: null, relatedTarget: function relatedTarget(a) {
      ...
      id$2 = { mouseEnter: { registrationName: "onMouseEnter", dependencies: ["mouseout", "mouseover"] },
    mouseLeave: { registrationName: "onMouseLeave", dependencies: ["mouseout", "mouseover"] }, pointerEnter: { registrationName: "onPointerEnter", dependencies: ["pointerout", "pointerover"] }, pointerLeave: { registrationName: "onPointerLeave", dependencies: ["pointerout", "pointerover"] } },
      jd = { eventTypes: id$2, extractEvents: function extractEvents(a, b, c, d) {
      var e = "mouseover" === a || "pointerover" === a,
          ...
          h = void 0,
          k = void 0,
          n = void 0;if ("mouseout" === a || "mouseover" === a) g = gd, h = id$2.mouseLeave, k = id$2.mouseEnter, n = "mouse";else if ("pointerout" === a || "pointerover" === a) g = hd, h = id$2.pointerLeave, k = id$2.pointerEnter, n = "pointer";a = null == f ? e : Oa(f);e = null == b ? e : Oa(b);h = g.getPooled(h, f, c, d);h.type = n + "leave";h.target = a;h.relatedTarget = e;c = g.getPooled(k, b, c, d);c.type = n + "enter";c.target = e;c.relatedTarget = a;Za(h, c, f, b);return [h, c];
    } };function kd(a) {
  ...
  function md(a) {
    var b = a.alternate;if (!b) return b = kd(a), 3 === b ? A$1("188") : void 0, 1 === b ? null : a;for (var c = a, d = b;;) {
      var e = c.return,
  ...
  }var pd = H$1.extend({ animationName: null, elapsedTime: null, pseudoElement: null }),
      qd = H$1.extend({ clipboardData: function clipboardData(a) {
  ...
  var td = { Esc: "Escape", Spacebar: " ", Left: "ArrowLeft", Up: "ArrowUp", Right: "ArrowRight", Down: "ArrowDown", Del: "Delete", Win: "OS", Menu: "ContextMenu", Apps: "ContextMenu", Scroll: "ScrollLock", MozPrintableKey: "Unidentified" },
    ...
    116: "F5", 117: "F6", 118: "F7", 119: "F8", 120: "F9", 121: "F10", 122: "F11", 123: "F12", 144: "NumLock", 145: "ScrollLock", 224: "Meta" },
      ...
      yd = H$1.extend({ propertyName: null, elapsedTime: null, pseudoElement: null }),
  ...
  if (ExecutionEnvironment_1.canUseDOM) {
    var le = "function" === typeof de ? de : function () {
      ...
      var c = -1;null != b && "number" === typeof b.timeout && (c = he() + b.timeout);if (-1 === ne || -1 !== c && c < ne) ne = c;a = { scheduledCallback: a, timeoutTime: c, prev: null, next: null };null === L$1 ? L$1 = a : (b = a.prev = me, null !== b && (b.next = a));me = a;pe || (pe = !0, le(we));return a;
    };ke = function ke(a) {
      if (null !== a.prev || L$1 === a) {
        var b = a.next,
            c = a.prev;a.next = null;a.prev = null;null !== b ? null !== c ? (c.next = b, b.prev = c) : (b.prev = null, L$1 = b) : null !== c ? (c.next = null, me = c) : me = L$1 = null;
      }
    };
  } else {
    ...
    a = objectAssign({ children: void 0 }, b);if (b = ye(b.children)) a.children = b;return a;
  }
  function Ae(a, b, c, d) {
    a = a.options;if (b) {
  ...
  function We(a, b, c, d) {
    var e = Re(b, c);switch (b) {case "iframe":case "object":
        ...
        Ic(a, c);f = Hc(a, c);K$1("invalid", a);Te(d, "onChange");break;case "option":
        f = ze(a, c);break;case "select":
        Be(a, c);f = objectAssign({}, c, { value: void 0 });
        K$1("invalid", a);Te(d, "onChange");break;case "textarea":
        De(a, c);f = Ce(a, c);K$1("invalid", a);Te(d, "onChange");break;default:
  ...
  function Xe(a, b, c, d, e) {
    var f = null;switch (b) {case "input":
        ...
        "function" !== typeof c.onClick && "function" === typeof d.onClick && (a.onclick = emptyFunction_1);}Qe(b, d, Se);b = a = void 0;var g = null;for (a in c) {
  ...
  function Ze(a, b, c, d, e) {
    switch (b) {case "iframe":case "object":
        ...
        Ic(a, c);K$1("invalid", a);Te(e, "onChange");break;case "select":
        Be(a, c);K$1("invalid", a);Te(e, "onChange");break;case "textarea":
        De(a, c), K$1("invalid", a), Te(e, "onChange");}Qe(b, c, Se);d = null;for (var f in c) {
          ...
          Lc(a, c);b = c.name;if ("radio" === c.type && null != b) {
            for (c = a; c.parentNode;) {
              ...
              var d = c[b];if (d !== a && d.form === a.form) {
                var e = Pa(d);e ? void 0 : A$1("90");dc(d);Lc(d, e);
              }
            }
          }break;case "textarea":
  ...
  function M$1(a) {
    ...
    mf++;lf[mf] = a.current;a.current = b;
      ...
      O$1 = nf(!1),
      pf = emptyObject_1;function qf(a) {
  ...
  function vf(a, b, c) {
    of.current !== emptyObject_1 ? A$1("168") : void 0;N$1(of, b, a);N$1(O$1, c, a);
  }function wf(a, b) {
    var c = a.stateNode,
    ...
    if (!rf(a)) return !1;var b = a.stateNode;b = b && b.__reactInternalMemoizedMergedChildContext || emptyObject_1;pf = of.current;N$1(of, b, a);N$1(O$1, O$1.current, a);return !0;
  }
  function yf(a, b) {
    var c = a.stateNode;c ? void 0 : A$1("169");if (b) {
      var d = wf(a, pf);c.__reactInternalMemoizedMergedChildContext = d;M$1(O$1, a);M$1(of, a);N$1(of, d, a);
  ...
  function Yf(a, b) {
    ...
    var b = a.type._context;N$1(ag, b._changedBits, a);N$1($f, b._currentValue, a);N$1(Zf, a, a);b._currentValue = a.pendingProps.value;b._changedBits = a.stateNode;
  }function cg(a) {
    var b = ag.current,
        c = $f.current;M$1(Zf, a);M$1($f, a);M$1(ag, a);a = a.type._context;a._currentValue = c;a._changedBits = b;
  }var dg = {},
      eg = nf(dg),
      fg = nf(dg),
      gg = nf(dg);function hg(a) {
    a === dg ? A$1("174") : void 0;return a;
  }
  function jg(a, b) {
    N$1(gg, b, a);N$1(fg, a, a);N$1(eg, dg, a);var c = b.nodeType;switch (c) {case 9:case 11:
        b = (b = b.documentElement) ? b.namespaceURI : Ie(null, "");break;default:
        c = 8 === c ? b.parentNode : b, b = c.namespaceURI || null, c = c.tagName, b = Ie(b, c);}M$1(eg, a);N$1(eg, b, a);
  }function kg(a) {
    M$1(eg, a);M$1(fg, a);M$1(gg, a);
  }function lg(a) {
  ...
  function tg(a, b) {
    var c = a.type,
        d = a.stateNode,
        e = a.pendingProps,
        f = qf(a);d.props = e;d.state = a.memoizedState;d.refs = emptyObject_1;d.context = sf(a, f);f = a.updateQueue;null !== f && (Vf(a, f, e, d, b), d.state = a.memoizedState);f = a.type.getDerivedStateFromProps;"function" === typeof f && (mg(a, f, e), d.state = a.memoizedState);"function" === typeof c.getDerivedStateFromProps || "function" === typeof d.getSnapshotBeforeUpdate || "function" !== typeof d.UNSAFE_componentWillMount && "function" !== typeof d.componentWillMount || (c = d.state, "function" === typeof d.componentWillMount && d.componentWillMount(), "function" === typeof d.UNSAFE_componentWillMount && d.UNSAFE_componentWillMount(), c !== d.state && qg.enqueueReplaceState(d, d.state, null), f = a.updateQueue, null !== f && (Vf(a, f, e, d, b), d.state = a.memoizedState));"function" === typeof d.componentDidMount && (a.effectTag |= 4);
  ...
  function Kg(a, b) {
    ...
    Kg(a, b);var f = 0 !== (b.effectTag & 64);if (!c && !f) return d && yf(b, !1), R$1(a, b);c = b.stateNode;ec.current = b;var g = f ? null : c.render();b.effectTag |= 1;f && (Jg(a, b, null, e), b.child = null);Jg(a, b, g, e);b.memoizedState = c.state;b.memoizedProps = c.props;d && yf(b, !0);return b.child;
  }
  function Mg(a) {
  ...
  function Rg(a, b, c) {
    var d = b.type._context,
        e = b.pendingProps,
        f = b.memoizedProps,
        g = !0;if (O$1.current) g = !1;else if (f === e) return b.stateNode = 0, bg(b), R$1(a, b);var h = e.value;b.memoizedProps = e;if (null === f) h = 1073741823;else if (f.value === e.value) {
      if (f.children === e.children && g) return b.stateNode = 0, bg(b), R$1(a, b);h = 0;
    } else {
    ...
    }b.stateNode = h;bg(b);Q$1(a, b, e.children);return b.child;
  }function R$1(a, b) {
      ...
      switch (b.tag) {case 3:
        ...
        Mg(b);e = b.updateQueue;if (null !== e) {
          if (d = b.memoizedState, d = null !== d ? d.element : null, Vf(b, e, b.pendingProps, null, c), e = b.memoizedState.element, e === d) Ig(), a = R$1(a, b);else {
            d = b.stateNode;if (d = (null === a || null === a.child) && d.hydrate) Bg = kf(b.stateNode.containerInfo), Ag = b, d = Cg = !0;d ? (b.effectTag |= 2, b.child = zg(b, null, e, c)) : (Ig(), Q$1(a, b, e));a = b.child;
          }
        } else Ig(), a = R$1(a, b);return a;case 5:
        a: {
          hg(gg.current);e = hg(eg.current);d = Ie(e, b.type);e !== d && (N$1(fg, b, b), N$1(eg, d, b));null === a && Fg(b);e = b.type;k = b.memoizedProps;d = b.pendingProps;f = null !== a ? a.memoizedProps : null;if (!O$1.current && k === d) {
            if (k = b.mode & 1 && !!d.hidden) b.expirationTime = 1073741823;if (!k || 1073741823 !== c) {
              a = R$1(a, b);break a;
            }
          }k = d.children;ef(e, d) ? k = null : f && ef(e, f) && (b.effectTag |= 16);Kg(a, b);1073741823 !== c && b.mode & 1 && d.hidden ? (b.expirationTime = 1073741823, b.memoizedProps = d, a = null) : (Q$1(a, b, k), b.memoizedProps = d, a = b.child);
        }return a;case 6:
        return null === a && Fg(b), b.memoizedProps = b.pendingProps, null;case 16:
        return null;case 4:
        return jg(b, b.stateNode.containerInfo), e = b.pendingProps, O$1.current || b.memoizedProps !== e ? (null === a ? b.child = yg(b, null, e, c) : Q$1(a, b, e), b.memoizedProps = e, a = b.child) : a = R$1(a, b), a;case 14:
  ...
  function Xg(a, b) {
    var c = b.pendingProps;switch (b.tag) {case 1:
        ...
        lg(b);d = hg(gg.current);var e = b.type;if (null !== a && null != b.stateNode) {
          ...
          if (!c) return null === b.stateNode ? A$1("166") : void 0, null;a = hg(eg.current);if (Hg(b)) c = b.stateNode, e = b.type, f = b.memoizedProps, c[C$1] = b, c[Ma] = f, d = Ze(c, e, f, a, d), b.updateQueue = d, null !== d && Tg(b);else {
            a = Ue(e, c, d, a);a[C$1] = b;a[Ma] = c;a: for (f = b.child; null !== f;) {
        ...
        if (a && null != b.stateNode) Wg(a, b, a.memoizedProps, c);else {
          if ("string" !== typeof c) return null === b.stateNode ? A$1("166") : void 0, null;d = hg(gg.current);hg(eg.current);Hg(b) ? (d = b.stateNode, c = b.memoizedProps, d[C$1] = b, $e(d, c) && Tg(b)) : (d = Ve(c, d), d[C$1] = b, b.stateNode = d);
        }return null;case 14:
        return null;case 16:
        return null;case 10:
        return null;case 11:
  ...
  function dh(a) {
    a: {
      for (var b = a.return; null !== b;) {
        ...
        A$1("161");}c.effectTag & 16 && (Le(b, ""), c.effectTag &= -17);a: b: for (c = a;;) {
      for (; null === c.sibling;) {
  ...
  function wh() {
    if (null !== S$1) for (var a = S$1.return; null !== a;) {
      var b = a;switch (b.tag) {case 2:
          ...
          kg(b);break;case 13:
          cg(b);}a = a.return;
    }rh = null;T$1 = 0;sh = -1;th = !1;S$1 = null;vh = !1;
  }
  function xh(a) {
    for (;;) {
      var b = a.alternate,
        ...
        b = Xg(b, a, T$1);var e = a;if (1073741823 === T$1 || 1073741823 !== e.expirationTime) {
        ...
        a = kh(a, th, T$1);if (null !== a) return a.effectTag &= 511, a;null !== c && (c.firstEffect = c.lastEffect = null, c.effectTag |= 512);if (null !== d) return d;if (null !== c) a = c;else break;
      }
    }return null;
  }
  function yh(a) {
    var b = Sg(a.alternate, a, T$1);null === b && (b = xh(a));ec.current = null;return b;
  }
  function zh(a, b, c) {
    qh ? A$1("243") : void 0;qh = !0;if (b !== T$1 || a !== rh || null === S$1) wh(), rh = a, T$1 = b, sh = -1, S$1 = Af(rh.current, null, T$1), a.pendingCommitExpirationTime = 0;var d = !1;th = !c || T$1 <= mh;do {
      try {
        ...
        if (null === S$1) d = !0, gh(f);else {
          null === S$1 ? A$1("271") : void 0;c = S$1;var e = c.return;if (null === e) {
            d = !0;gh(f);break;
          }jh(a, e, c, f, th, T$1, nh);S$1 = xh(c);
        }
      }break;
    } while (1);qh = !1;if (d) return null;if (null === S$1) {
      if (vh) return a.pendingCommitExpirationTime = b, a.current.alternate;th ? A$1("262") : void 0;0 <= sh && setTimeout(function () {
  ...
  function $g(a, b) {
    var c;a: {
      qh && !uh ? A$1("263") : void 0;for (c = a.return; null !== c;) {
        switch (c.tag) {case 2:
  ...
  function Dh() {
    ...
    a = 0 !== ph ? ph : qh ? uh ? 1 : T$1 : b.mode & 1 ? Eh ? 2 + 10 * (((a - 2 + 15) / 10 | 0) + 1) : 2 + 25 * (((a - 2 + 500) / 25 | 0) + 1) : 1;Eh && (0 === Fh || a > Fh) && (Fh = a);return a;
  }
  function pg(a, b) {
    for (; null !== a;) {
      if (0 === a.expirationTime || a.expirationTime > b) a.expirationTime = b;null !== a.alternate && (0 === a.alternate.expirationTime || a.alternate.expirationTime > b) && (a.alternate.expirationTime = b);if (null === a.return) if (3 === a.tag) {
        var c = a.stateNode;!qh && 0 !== T$1 && b < T$1 && wh();var d = c.current.expirationTime;qh && !uh && rh === c || Bh(c, d);Gh > Hh && A$1("185");
  ...
  function Yh() {
    var a = 0,
        b = null;if (null !== V$1) for (var c = V$1, d = Kh; null !== d;) {
      var e = d.remainingExpirationTime;if (0 === e) {
        null === c || null === V$1 ? A$1("244") : void 0;if (d === d.nextScheduledRoot) {
          Kh = V$1 = d.nextScheduledRoot = null;break;
        } else if (d === Kh) Kh = e = d.nextScheduledRoot, V$1.nextScheduledRoot = e, d.nextScheduledRoot = null;else if (d === V$1) {
          V$1 = c;V$1.nextScheduledRoot = Kh;d.nextScheduledRoot = null;break;
        } else c.nextScheduledRoot = d.nextScheduledRoot, d.nextScheduledRoot = null;d = c.nextScheduledRoot;
      } else {
        if (0 === a || e < a) a = e, b = d;if (d === V$1) break;
        c = d;d = d.nextScheduledRoot;
      }
    }c = X$1;null !== c && c === b && 1 === a ? Gh++ : Gh = 0;X$1 = b;Y$1 = a;
  }function Vh(a) {
    Zh(0, !0, a);
  }function Xh() {
    Zh(1, !1, null);
  }function Zh(a, b, c) {
    Qh = c;Yh();if (b) for (; null !== X$1 && 0 !== Y$1 && (0 === a || a >= Y$1) && (!Nh || ng() >= Y$1);) {
      ng(), Wh(X$1, Y$1, !Nh), Yh();
    } else for (; null !== X$1 && 0 !== Y$1 && (0 === a || a >= Y$1);) {
      Wh(X$1, Y$1, !1), Yh();
    }null !== Qh && (Lh = 0, Mh = null);0 !== Y$1 && Uh(Y$1);Qh = null;Nh = !1;$h();
  }function ai(a, b) {
    W$1 ? A$1("253") : void 0;X$1 = a;Y$1 = b;Wh(a, b, !1);Xh();$h();
  }
  function $h() {
    Gh = 0;if (null !== Sh) {
    ...
    W$1 ? A$1("245") : void 0;W$1 = !0;c ? (c = a.finishedWork, null !== c ? bi(a, c, b) : (c = zh(a, b, !0), null !== c && (Ah() ? a.finishedWork = c : bi(a, c, b)))) : (c = a.finishedWork, null !== c ? bi(a, c, b) : (c = zh(a, b, !1), null !== c && bi(a, c, b)));W$1 = !1;
  }
  function bi(a, b, c) {
    var d = a.firstBatch;if (null !== d && d._expirationTime <= c && (null === Sh ? Sh = [d] : Sh.push(d), d._defer)) {
    ...
    }a.finishedWork = null;uh = qh = !0;c = b.stateNode;c.current === b ? A$1("177") : void 0;d = c.pendingCommitExpirationTime;0 === d ? A$1("261") : void 0;c.pendingCommitExpirationTime = 0;ng();ec.current = null;if (1 < b.effectTag) {
      if (null !== b.lastEffect) {
        b.lastEffect.nextEffect = b;var e = b.firstEffect;
      } else e = b;
    } else e = b.firstEffect;bf = Id;var f = getActiveElement_1();if (Vd(f)) {
    ...
    } else g = null;cf = { focusedElem: f, selectionRange: g };Kd(!1);for (U$1 = e; null !== U$1;) {
      f = !1;g = void 0;try {
        for (; null !== U$1;) {
      ...
      u = !1;y = void 0;try {
        for (; null !== U$1;) {
          var q = U$1.effectTag;q & 16 && Le(U$1.stateNode, "");if (q & 128) {
            var z = U$1.alternate;if (null !== z) {
              var l = z.ref;null !== l && ("function" === typeof l ? l(null) : l.current = null);
            }
          }switch (q & 14) {case 2:
              dh(U$1);U$1.effectTag &= -3;break;case 6:
              dh(U$1);U$1.effectTag &= -3;eh(U$1.alternate, U$1);break;case 4:
              eh(U$1.alternate, U$1);break;case 8:
              D = U$1, bh(D), D.return = null, D.child = null, D.alternate && (D.alternate.child = null, D.alternate.return = null);}U$1 = U$1.nextEffect;
        }
      } catch (Wa) {
        u = !0, y = Wa;
      }u && (null === U$1 ? A$1("178") : void 0, $g(U$1, y), null !== U$1 && (U$1 = U$1.nextEffect));
    }l = cf;z = getActiveElement_1();q = l.focusedElem;u = l.selectionRange;if (z !== q && containsNode_1(document.documentElement, q)) {
    ...
    }cf = null;Kd(bf);bf = null;c.current = b;for (U$1 = e; null !== U$1;) {
      e = !1;q = void 0;try {
        for (z = d; null !== U$1;) {
          var ig = U$1.effectTag;if (ig & 36) {
            ...
            l = void 0;var yc = U$1.ref;if (null !== yc) {
              var Qg = U$1.stateNode;switch (U$1.tag) {case 5:
                  l = Qg;break;default:
                  l = Qg;}"function" === typeof yc ? yc(l) : yc.current = l;
            }
          }var Ai = U$1.nextEffect;U$1.nextEffect = null;U$1 = Ai;
        }
      } catch (Wa) {
        e = !0, q = Wa;
  ...
  function gh(a) {
    null === X$1 ? A$1("246") : void 0;X$1.remainingExpirationTime = 0;Oh || (Oh = !0, Ph = a);
  }function Ch(a) {
  ...
  function fi(a, b, c) {
    if (Eh) return a(b, c);Z$1 || W$1 || 0 === Fh || (Zh(Fh, !1, null), Fh = 0);var d = Eh,
        e = Z$1;Z$1 = Eh = !0;try {
      return a(b, c);
    } finally {
      Eh = d, (Z$1 = e) || W$1 || Xh();
  ...
  function hi(a, b, c, d, e) {
    var f = b.current;if (c) {
      c = c._reactInternalFiber;var g;b: {
        2 === kd(c) && 2 === c.tag ? void 0 : A$1("170");for (g = c; 3 !== g.tag;) {
          if (rf(g)) {
            g = g.stateNode.__reactInternalMemoizedMergedChildContext;break b;
          }(g = g.return) ? void 0 : A$1("171");
        }g = g.stateNode.context;
      }c = rf(c) ? wf(c, g) : g;
    } else c = emptyObject_1;null === b.context ? b.context = c : b.pendingContext = c;b = e;e = Pf(d);e.payload = { element: a };b = void 0 === b ? null : b;null !== b && (e.callback = b);Rf(f, e, d);pg(f, d);return d;
  }
  function ii(a) {
    var b = a._reactInternalFiber;void 0 === b && ("function" === typeof a.render ? A$1("188") : A$1("268", Object.keys(a)));a = nd(b);return null === a ? null : a.stateNode;
  }function ji(a, b, c, d) {
    var e = b.current,
  ...
  function li(a) {
    var b = a.findFiberByHostInstance;return Jf(objectAssign({}, a, { findHostInstanceByFiber: function findHostInstanceByFiber(a) {
  ...
  Kb.injectFiberControlledHostComponent(af);Sb = mi.batchedUpdates;Tb = mi.interactiveUpdates;Ub = mi.flushInteractiveUpdates;
  ...
  var reactDom_development=createCommonjsModule(function(module){{(function(){var invariant=invariant_1;var React=react;var warning=warning_1;var ExecutionEnvironment=ExecutionEnvironment_1;var _assign=objectAssign;var emptyFunction=emptyFunction_1;var checkPropTypes=checkPropTypes_1;var getActiveElement=getActiveElement_1;var shallowEqual=shallowEqual_1;var containsNode=containsNode_1;var emptyObject=emptyObject_1;var hyphenateStyleName=hyphenateStyleName_1;var camelizeStyleName=camelizeStyleName_1;// Relying on the `invariant()` implementation lets us
  ...
  if(node.hasOwnProperty(valueField)||typeof descriptor==='undefined'||typeof descriptor.get!=='function'||typeof descriptor.set!=='function'){return;}var _get=descriptor.get,_set=descriptor.set;Object.defineProperty(node,valueField,{configurable:true,get:function get$$1(){return _get.call(this);},set:function set$$1(value){currentValue=''+value;_set.call(this,value);}});// We could've passed this the first time
   ...
   */function get$$1(key){return key._reactInternalFiber;}function has(key){return key._reactInternalFiber!==undefined;}function set$$1(key,value){key._reactInternalFiber=value;}// Don't change these two values. They're used by React Dev Tools.
  ...
  // TODO: Only ignore them on controlled tags.
  propKey==='value'||propKey==='checked'||propKey==='selected');else if(propKey===DANGEROUSLY_SET_INNER_HTML){var rawHtml=nextProp?nextProp[HTML]||'':'';var serverHTML=domElement.innerHTML;var expectedHTML=normalizeHTML(domElement,rawHtml);if(expectedHTML!==serverHTML){warnForPropDifference(propKey,serverHTML,expectedHTML);}}else if(propKey===STYLE){// $FlowFixMe - Should be inferred as not undefined.
  ...
  if(currentFiber!==null){resumeTimersRecursively(currentFiber);}};function recordEffect(){{effectCountInCurrentCommit++;}}function recordScheduleUpdate(){{if(isCommitting){hasScheduledUpdateInCurrentCommit=true;}if(currentPhase!==null&&currentPhase!=='componentWillMount'&&currentPhase!=='componentWillReceiveProps'){hasScheduledUpdateInCurrentPhase=true;}}}function startRequestCallbackTimer(){{if(supportsUserTiming&&!isWaitingForCallback){isWaitingForCallback=true;beginMark('(Waiting for async callback...)');}}}function stopRequestCallbackTimer(didExpire,expirationTime){{if(supportsUserTiming){isWaitingForCallback=false;var warning$$1=didExpire?'React was blocked by main thread':null;endMark('(Waiting for async callback... will force flush in '+expirationTime+' ms)','(Waiting for async callback...)',warning$$1);}}}function startWorkTimer(fiber){{if(!supportsUserTiming||shouldIgnoreFiber(fiber)){return;}// If we pause, this is the fiber to unwind from.
  ...
  function markCommittedPriorityLevels(root,currentTime,earliestRemainingTime){}function findNextPendingPriorityLevel(root){{return root.current.expirationTime;}}// UpdateQueue is a linked list of prioritized updates.
  //
  ...
  rendererSigil={};}function pushProvider(providerFiber){var context=providerFiber.type._context;{push(changedBitsCursor,context._changedBits,providerFiber);push(valueCursor,context._currentValue,providerFiber);push(providerCursor,providerFiber,providerFiber);context._currentValue=providerFiber.pendingProps.value;context._changedBits=providerFiber.stateNode;{!(context._currentRenderer===undefined||context._currentRenderer===null||context._currentRenderer===rendererSigil)?warning(false,'Detected multiple renderers concurrently rendering the '+'same context provider. This is currently unsupported.'):void 0;context._currentRenderer=rendererSigil;}}}function popProvider(providerFiber){var changedBits=changedBitsCursor.current;var currentValue=valueCursor.current;pop(providerCursor,providerFiber);pop(valueCursor,providerFiber);pop(changedBitsCursor,providerFiber);var context=providerFiber.type._context;{context._currentValue=currentValue;context._changedBits=changedBits;}}function getContextCurrentValue(context){return context._currentValue;}function getContextChangedBits(context){return context._changedBits;}var NO_CONTEXT={};var contextStackCursor$1=createCursor(NO_CONTEXT);var contextFiberStackCursor=createCursor(NO_CONTEXT);var rootInstanceStackCursor=createCursor(NO_CONTEXT);function requiredContext(c){!(c!==NO_CONTEXT)?invariant(false,'Expected host context to exist. This error is likely caused by a bug in React. Please file an issue.'):void 0;return c;}function getRootHostContainer(){var rootInstance=requiredContext(rootInstanceStackCursor.current);return rootInstance;}function pushHostContainer(fiber,nextRootInstance){// Push current root instance onto the stack;
  ...
  if(contextFiberStackCursor.current!==fiber){return;}pop(contextStackCursor$1,fiber);pop(contextFiberStackCursor,fiber);}var commitTime=0;function getCommitTime(){return commitTime;}function recordCommitTime(){commitTime=now();}/**
   * The "actual" render time is total time required to render the descendants of a Profiler component.
   * This time is stored as a stack, since Profilers can be nested.
   * This time is started during the "begin" phase and stopped during the "complete" phase.
   * It is paused (and accumulated) in the event of an interruption or an aborted render.
   */var fiberStack$1=void 0;{fiberStack$1=[];}var timerPausedAt=0;var totalElapsedPauseTime=0;function checkActualRenderTimeStackEmpty(){{!(fiberStack$1.length===0)?warning(false,'Expected an empty stack. Something was not reset properly.'):void 0;}}function markActualRenderTimeStarted(fiber){{fiberStack$1.push(fiber);}fiber.actualDuration=now()-fiber.actualDuration-totalElapsedPauseTime;fiber.actualStartTime=now();}function pauseActualRenderTimerIfRunning(){if(timerPausedAt===0){timerPausedAt=now();}}function recordElapsedActualRenderTime(fiber){{!(fiber===fiberStack$1.pop())?warning(false,'Unexpected Fiber (%s) popped.',getComponentName(fiber)):void 0;}fiber.actualDuration=now()-totalElapsedPauseTime-fiber.actualDuration;}function resetActualRenderTimer(){totalElapsedPauseTime=0;}function resumeActualRenderTimerIfPaused(){if(timerPausedAt>0){totalElapsedPauseTime+=now()-timerPausedAt;timerPausedAt=0;}}/**
   * The "base" render time is the duration of the “begin” phase of work for a particular fiber.
   * This time is measured and stored on each fiber.
   * The time for all sibling fibers are accumulated and stored on their parent during the "complete" phase.
   * If a fiber bails out (sCU false) then its "base" timer is cancelled and the fiber is not updated.
   */var baseStartTime=-1;function recordElapsedBaseRenderTimeIfRunning(fiber){if(baseStartTime!==-1){fiber.selfBaseTime=now()-baseStartTime;}}function startBaseRenderTimer(){{if(baseStartTime!==-1){warning(false,'Cannot start base timer that is already running. '+'This error is likely caused by a bug in React. '+'Please file an issue.');}}baseStartTime=now();}function stopBaseRenderTimerIfRunning(){baseStartTime=-1;}var fakeInternalInstance={};var isArray=Array.isArray;var didWarnAboutStateAssignmentForComponent=void 0;var didWarnAboutUninitializedState=void 0;var didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate=void 0;var didWarnAboutLegacyLifecyclesAndDerivedState=void 0;var didWarnAboutUndefinedDerivedState=void 0;var warnOnUndefinedDerivedState=void 0;var warnOnInvalidCallback$1=void 0;{didWarnAboutStateAssignmentForComponent=new Set();didWarnAboutUninitializedState=new Set();didWarnAboutGetSnapshotBeforeUpdateWithoutDidUpdate=new Set();didWarnAboutLegacyLifecyclesAndDerivedState=new Set();didWarnAboutUndefinedDerivedState=new Set();var didWarnOnInvalidCallback=new Set();warnOnInvalidCallback$1=function warnOnInvalidCallback$1(callback,callerName){if(callback===null||typeof callback==='function'){return;}var key=callerName+'_'+callback;if(!didWarnOnInvalidCallback.has(key)){didWarnOnInvalidCallback.add(key);warning(false,'%s(...): Expected the last optional `callback` argument to be a '+'function. Instead received: %s.',callerName,callback);}};warnOnUndefinedDerivedState=function warnOnUndefinedDerivedState(workInProgress,partialState){if(partialState===undefined){var componentName=getComponentName(workInProgress)||'Component';if(!didWarnAboutUndefinedDerivedState.has(componentName)){didWarnAboutUndefinedDerivedState.add(componentName);warning(false,'%s.getDerivedStateFromProps(): A valid state object (or null) must be returned. '+'You have returned undefined.',componentName);}}};// This is so gross but it's at least non-critical and can be removed if
  ...
  nextChildren=null;{stopBaseRenderTimerIfRunning();}}else{{ReactDebugCurrentFiber.setCurrentPhase('render');nextChildren=instance.render();if(workInProgress.mode&StrictMode){instance.render();}ReactDebugCurrentFiber.setCurrentPhase(null);}}// React DevTools reads this flag.
  ...
  workInProgress.effectTag|=PerformedWork;reconcileChildren(current,workInProgress,newChildren);return workInProgress.child;}/*
    ...
    */function bailoutOnAlreadyFinishedWork(current,workInProgress){cancelWorkTimer(workInProgress);{// Don't update "base" render times for bailouts.
  ...
  //   return null;
  // }
  cloneChildFibers(current,workInProgress);return workInProgress.child;}function bailoutOnLowPriority(current,workInProgress){cancelWorkTimer(workInProgress);{// Don't update "base" render times for bailouts.
  ...
  if(oldText!==newText){markUpdate(workInProgress);}};}function completeWork(current,workInProgress,renderExpirationTime){var newProps=workInProgress.pendingProps;{if(workInProgress.mode&ProfileMode){recordElapsedActualRenderTime(workInProgress);}}switch(workInProgress.tag){case FunctionalComponent:return null;case ClassComponent:{// We are leaving this subtree, so pop context if any.
  ...
  {unmountHostComponents(current);}return;}}}function commitNestedUnmounts(root){// While we're inside a removed host node we don't want to call
  ...
  current.return=null;current.child=null;if(current.alternate){current.alternate.child=null;current.alternate.return=null;}}function getHostParentFiber(fiber){var parent=fiber.return;while(parent!==null){if(isHostParent(parent)){return parent;}parent=parent.return;}invariant(false,'Expected to find a host parent. This error is likely caused by a bug in React. Please file an issue.');}function isHostParent(fiber){return fiber.tag===HostComponent||fiber.tag===HostRoot||fiber.tag===HostPortal;}function getHostSibling(fiber){// We're going to search forward into the tree until we find a sibling host
  ...
  // not defined.
  markLegacyErrorBoundaryAsFailed(this);}var error=errorInfo.value;var stack=errorInfo.stack;logError(fiber,errorInfo);this.componentDidCatch(error,{componentStack:stack!==null?stack:''});};}return update;}function throwException(root,returnFiber,sourceFiber,value,renderIsExpired,renderExpirationTime,currentTimeMs){// The source fiber did not complete.
  ...
  isReplayingFailedUnitOfWork=true;originalReplayError=thrownValue;invokeGuardedCallback$2(null,workLoop,null,isAsync);isReplayingFailedUnitOfWork=false;originalReplayError=null;if(hasCaughtError()){clearCaughtError();{if(failedUnitOfWork.mode&ProfileMode){recordElapsedActualRenderTime(failedUnitOfWork);}// Stop "base" render timer again (after the re-thrown error).
  ...
  var next=completeWork(current,workInProgress,nextRenderExpirationTime);stopWorkTimer(workInProgress);resetExpirationTime(workInProgress,nextRenderExpirationTime);{ReactDebugCurrentFiber.resetCurrentFiber();}if(next!==null){stopWorkTimer(workInProgress);// back here again.
  ...
  stopFailedWorkTimer(workInProgress);}else{stopWorkTimer(workInProgress);}{ReactDebugCurrentFiber.resetCurrentFiber();}if(_next!==null){stopWorkTimer(workInProgress);// back here again.
  ...
  startWorkTimer(workInProgress);{ReactDebugCurrentFiber.setCurrentFiber(workInProgress);}{stashedWorkInProgressProperties=assignFiberPropertiesInDEV(stashedWorkInProgressProperties,workInProgress);}var next=void 0;{if(workInProgress.mode&ProfileMode){startBaseRenderTimer();}next=beginWork(current,workInProgress,nextRenderExpirationTime);if(workInProgress.mode&ProfileMode){// Update "base" time if the render wasn't bailed out on.
  recordElapsedBaseRenderTimeIfRunning(workInProgress);stopBaseRenderTimerIfRunning();}}{ReactDebugCurrentFiber.resetCurrentFiber();if(isReplayingFailedUnitOfWork){// Currently replaying a failed unit of work. This should be unreachable,
  ...
  while(nextUnitOfWork!==null&&!shouldYield()){nextUnitOfWork=performUnitOfWork(nextUnitOfWork);}{// If we didn't finish, pause the "actual" render timer.
  ...
  resetCurrentlyProcessingQueue();}var failedUnitOfWork=nextUnitOfWork;{replayUnitOfWork(failedUnitOfWork,thrownValue,isAsync);}// TODO: we already know this isn't true in some cases.
  ...
  function retrySuspendedRoot(root,suspendedTime){var retryTime=findNextPendingPriorityLevel(root);if(retryTime!==NoWork){requestRetry(root,retryTime);}}function scheduleWork$1(fiber,expirationTime){recordScheduleUpdate();{if(fiber.tag===ClassComponent){var instance=fiber.stateNode;warnAboutInvalidUpdates(instance);}}var node=fiber;while(node!==null){// Walk the parent path to the root and update each node's
  // expiration time.
  ...
  interruptedBy=fiber;resetStack();}var nextExpirationTimeToWorkOn=findNextPendingPriorityLevel(root);if(// If we're in the render phase, we don't need to schedule this root
  ...
  // the deadline.
  findHighestPriorityRoot();{resumeActualRenderTimerIfPaused();}if(deadline!==null){var didExpire=nextFlushedExpirationTime<recalculateCurrentTime();var timeout=expirationTimeToMs(nextFlushedExpirationTime);stopRequestCallbackTimer(didExpire,timeout);}if(isAsync){while(nextFlushedRoot!==null&&nextFlushedExpirationTime!==NoWork&&(minExpirationTime===NoWork||minExpirationTime>=nextFlushedExpirationTime)&&(!deadlineDidExpire||recalculateCurrentTime()>=nextFlushedExpirationTime)){recalculateCurrentTime();performWorkOnRoot(nextFlushedRoot,nextFlushedExpirationTime,!deadlineDidExpire);findHighestPriorityRoot();}}else{while(nextFlushedRoot!==null&&nextFlushedExpirationTime!==NoWork&&(minExpirationTime===NoWork||minExpirationTime>=nextFlushedExpirationTime)){performWorkOnRoot(nextFlushedRoot,nextFlushedExpirationTime,false);findHighestPriorityRoot();}}// We're done flushing work. Either we ran out of time in this callback,
  ...
  root.finishedWork=_finishedWork;{// If we didn't finish, pause the "actual" render timer.
  // We'll restart it when we resume work.
  ...
  var fail = function fail(s) {
    throw new Error(s);
  };
  var qs = function qs(s, el) {
  ...
  var _createEventAdapter = createEventAdapter(scheduler),
      _createEventAdapter2 = slicedToArray(_createEventAdapter, 2),
      addAction = _createEventAdapter2[0],
      todoActions = _createEventAdapter2[1];
  ...
  var viewUpdates = tap$$1(function (rel) {
    return reactDom_1(rel, appNode);
  }, map$1(View(addAction), stateUpdates));
