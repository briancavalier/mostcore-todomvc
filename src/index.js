...
import { skipRepeats, map, scan, tap, runEffects } from '@most/core'
import { newDefaultScheduler } from '@most/scheduler'
import { hashchange } from '@most/dom-event'
import { inject } from 'most-product'

import { emptyApp } from './model'
import { View } from './view.jsx'
import { handleFilterChange } from './action'
import { interpretTodos, interpretFilterChange, composeInterpreters } from './interpret'
...
const actions = inject(todoActions, updateFilter)

const interpret = composeInterpreters(interpretTodos, interpretFilterChange)

const stateUpdates = skipRepeats(scan(interpret, appState, actions))
